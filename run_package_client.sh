...
# ROS2 패키지 기반 Draco Client 실행 스크립트

echo "=== ROS2 Package-based Draco Client ==="
...
echo "Starting Draco Client using ROS2 launch..."
echo "Features:"
...
# Launch 파일로 실행
ros2 launch lidar_draco_bridge draco_client.launch.py
