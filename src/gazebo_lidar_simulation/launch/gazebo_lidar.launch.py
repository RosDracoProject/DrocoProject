...
"""
Launch file for Gazebo 3D LiDAR simulation with TCP Point Cloud Transport
"""
...
def generate_launch_description():
    ...
    world_file_arg = DeclareLaunchArgument(
        'world_file',
        default_value=os.path.join(pkg_gazebo_lidar, 'worlds', 'lidar_test_world.world'),
    ...
    spawn_robot = Node(
        ...
        arguments=['-entity', 'lidar_robot', '-file', 
                  os.path.join(pkg_gazebo_lidar, 'models', 'lidar_robot', 'lidar_robot.sdf')],
        output='screen'
    )
    ...
    static_tf_publisher = Node(
        ...
        arguments=['0', '0', '0.5', '0', '0', '0', 'world', 'base_link'],
        output='screen'
    )
